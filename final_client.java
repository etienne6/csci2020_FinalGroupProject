...
public class final_client extends javax.swing.JFrame
{
    ...
    //this will send the information to the server, then server will send to client
    ...
    public static void main(String args[])
    {
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            ...
            public void run()
            {
                new final_client().setVisible(true);
            }
        });
    }
